...
def services_mock(mocker, requests_mock):
    ...
    requests_mock.get('https://api-us.cloud.com/systemlog/dvintfd45cca/records',
                      status_code=200,
                      text=read_datafile('systemlog_GetRecords.response'))
    
    requests_mock.post('https://notifications.citrixworkspacesapi.net/dvintfd45cca/Notifications/Items',
                      status_code=200,
                      text="{}")

    requests_mock.post('https://api-us.cloud.com/cctrustoauth2/dvintfd45cca/tokens/clients',
                       status_code=200,
